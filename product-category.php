...
<head>
    ...
    <title>Surya Travel | <?php echo $category?></title>
                ...
                <div class="media-container-row">
                        <div class="title col-12 col-md-8">
                                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1"><span style="font-weight: normal;">
                                        PAKET</span></h2>
                                <h3 class="text-uppercase mbr-section-subtitle align-center mbr-light mbr-white pb-3 mbr-fonts-style display-1"><strong>
                                        <?php echo $category; ?></strong></h3>
                        ...
                        <div class="col-12">
                                <div class="media-container-row">
                                    <table class="table" style="width: 100%;border: 1px solid #aaa;border-radius: 50%">
                                        <tbody>
                                        <?php 
                                        $get_product = mysqli_query($con,"select * from produk_umroh where kategori = '$category' and status_tutup = '0' ");
